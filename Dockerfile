...
RUN mvn install:install-file -Dfile=/home/tc-informix-dal/tc-dal-rdb-proto-1.0-SNAPSHOT.jar -DgroupId=com.tc -DartifactId=tc-dal-rdb-proto -Dversion=1.0-SNAPSHOT -Dpackaging=jar
