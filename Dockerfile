...
COPY scripts /home/tc-informix-dal/scripts
COPY tc-dal-rdb-proto-1.0-SNAPSHOT.jar /home/tc-informix-dal
RUN mvn install:install-file -Dfile=/home/tc-informix-dal/tc-dal-rdb-proto-1.0-SNAPSHOT.jar -DgroupId=com.topcoder -DartifactId=tc-dal-rdb-proto -Dversion=1.0-SNAPSHOT -Dpackaging=jar
...
COPY --from=builder /home/tc-informix-dal/scripts /app/scripts
